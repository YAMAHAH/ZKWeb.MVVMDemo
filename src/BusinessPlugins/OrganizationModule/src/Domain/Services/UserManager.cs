...
using ZKWeb.MVVMPlugins.OrganizationModule.src.Components.ExtraConfigKeys;
using ZKWeb.MVVMPlugins.OrganizationModule.src.Components.UserLoginHandlers.Interfaces;
    ...
    public class UserManager : DomainServiceBase<User, Guid>
    {
        ...
        public virtual IFileEntry GetAvatarStorageFile(Guid userId)
        {
            ...
            return fileStorage.GetStorageFile(
                "static", "OrganizationModule.images", string.Format("avatar_{0}.jpg", userId));
        }
