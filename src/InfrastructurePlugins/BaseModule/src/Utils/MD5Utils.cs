...
namespace CoreLibModule.Utils
{
    public static class MD5Utils
    {
        ...
        public static Guid GetGuidByMD5(String input, string format = "X2")
        {
            string result = "";
        ...
        public static string GetGuidStrByMD5(String input, string format = "X2")
        {
            string result = "";
            byte[] md5Hash = GetMD5_Hash(input);
            // 通过使用循环，将字节类型的数组转换为字符串，此字符串是常规字符格式化所得
